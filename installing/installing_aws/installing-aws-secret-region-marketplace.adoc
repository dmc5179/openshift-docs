...
= Installing a cluster on AWS into a Secret or Top Secret Region using the AWS market place
include::_attributes/common-attributes.adoc[]
:context: installing-aws-secret-region

toc::[]

In {product-title} version {product-version}, you can install a cluster on Amazon Web Services (AWS) into the following secret regions using the AWS marketplace available in these regions:
...
// Added to support the AWS IC Marketplace
...
include::modules/installation-aws-icmp-content-ami.adoc[leveloffset=+1]
include::modules/installation-aws-icmp-automation-parameters.adoc[leveloffset=+2]
include::modules/installation-aws-icmp-automated-install.adoc[leveloffset=+1]
include::modules/installation-aws-icmp-post-install.adoc[leveloffset=+1]
// End, added to support the AWS IC Marketplace
